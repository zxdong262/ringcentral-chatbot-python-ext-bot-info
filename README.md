...
Just follow [ringcentral-chatbot-python#use-extensions](https://github.com/zxdong262/ringcentral-chatbot-python#use-extensions), set `EXTENSIONS=ringcentral_bot_framework_extension_botinfo`
